...
class ElectronicGoodsView: UIView {
    ...
    */
    override func draw(_ rect: CGRect) {
        ...
        titleLabel.text = "winningmart goods series"
        ...
        goodsImageView.backgroundColor = UIColor.green
        ...
        goodsDescriptionLabel.text = "Leading the market of electronic goods,Get your business started and make your life better."
